...
const NeuralFallback = () => (
  <div className="fixed inset-0 z-[9999] bg-royal-950 flex flex-col items-center justify-center gap-6">
    ...
    <div className="text-center space-y-2">
      <div className="text-[10px] font-black text-white uppercase tracking-tight">Loading</div>
      <div className="text-[8px] font-mono text-slate-500 uppercase tracking-widest italic">Fetching assets...</div>
    </div>
  </div>
);
