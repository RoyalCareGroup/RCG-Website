  ...
  return (
    <div className="flex flex-col bg-transparent overflow-x-hidden min-h-screen px-6 sm:px-16 lg:px-24 font-sans relative">
      <div className="max-w-7xl mx-auto relative z-10 pt-24 pb-16 w-full">
        ...
        <div className="mb-10 animate-hero-reveal">
          <Link to="/" className="inline-flex items-center text-[10px] font-black uppercase tracking-[0.4em] text-slate-500 dark:text-slate-600 hover:text-neon-gold transition-colors mb-6 group">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl font-mono font-black uppercase tracking-tighter leading-[0.85] animate-liquid-shimmer">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-16 items-stretch">
          <div className="lg:col-span-7">
            <div className="orbital-tile !bg-transparent !border !border-white/10 !shadow-none hover:!border-neon-gold/40 hover:!shadow-[0_0_20px_rgba(229,199,139,0.1)] p-6 lg:p-10 rounded-2xl relative overflow-hidden flex flex-col h-full">
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="pt-6 border-t border-white/5 flex items-center gap-8">
                   <div className="orbital-tile !bg-transparent !border !border-white/10 !shadow-none hover:!border-neon-gold/40 hover:!shadow-[0_0_20px_rgba(229,199,139,0.1)] !rounded-2xl p-6 bg-royal-950 shadow-inner border-neon-gold/20">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            {coreValues.map((item, i) => (
              <div key={i} className="orbital-tile !bg-transparent !border !border-white/10 !shadow-none hover:!border-neon-gold/40 hover:!shadow-[0_0_20px_rgba(229,199,139,0.1)] p-6 group transition-all rounded-2xl flex flex-col justify-center flex-1">
        ...
        <div className="orbital-tile !bg-transparent !border !border-white/10 !shadow-none hover:!border-neon-gold/40 hover:!shadow-[0_0_20px_rgba(229,199,139,0.1)] !rounded-[4rem] p-6 md:p-10 relative overflow-hidden group rounded-2xl text-center">
          <div className="relative z-10 flex flex-col items-center space-y-6">
             ...
             <h2 className="text-4xl md:text-5xl font-mono font-black text-white uppercase leading-[0.85] tracking-tighter">
