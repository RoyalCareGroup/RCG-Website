    ...
    <div className="min-h-screen bg-[#01040f] text-slate-300 py-32 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-black text-white mb-10 uppercase tracking-tighter leading-[0.9]">
            Experience-Led <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-neon-purple">Intelligence.</span>
          </h1>
          <p className="text-xl text-slate-400 font-light leading-relaxed border-l-4 border-royal-800 pl-8">
        ...
        <div className="orbital-tile p-10 md:p-14 mb-16 shadow-2xl relative">
          ...
          <div className="orbital-content space-y-8 text-lg leading-relaxed font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-10">
               {[
                 ...
                 <div key={i} className="flex items-center space-x-4 p-4 bg-royal-950/50 border border-royal-800 rounded-xl group hover:border-neon-blue transition-colors">
                    <CheckCircle2 className="text-neon-blue shrink-0 group-hover:scale-110 transition-transform" size={18} />
                    <span className="text-[10px] font-black text-white uppercase tracking-widest">{item}</span>
                 </div>
               ))}
            </div>

            <div className="border-l-4 border-neon-purple pl-10 py-6 bg-royal-950/40 italic text-white rounded-r-2xl shadow-inner text-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="orbital-tile p-8 group">
            <div className="orbital-content">
              <div className="p-3 bg-neon-blue/10 rounded-xl border border-neon-blue/20 w-fit mb-5 group-hover:scale-110 transition-transform">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed font-light">Remotely accessible to every NDIS provider in Australia.</p>
            </div>
          </div>
          <div className="orbital-tile p-8 group">
            <div className="orbital-content">
              <div className="p-3 bg-neon-purple/10 rounded-xl border border-neon-purple/20 w-fit mb-5 group-hover:scale-110 transition-transform">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed font-light">Identifying structural revenue leakage and administrative debt.</p>
            </div>
          </div>
          <div className="orbital-tile p-8 group">
            <div className="orbital-content">
              <div className="p-3 bg-neon-green/10 rounded-xl border border-neon-green/20 w-fit mb-5 group-hover:scale-110 transition-transform">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed font-light">Bridging the gap between front-line care and technical precision.</p>
            </div>
          </div>
        </div>

        <div className="mt-24 p-12 glass rounded-[2.5rem] border border-royal-800 text-center">
          ...
          <button className="px-12 py-5 bg-white text-black font-black text-[10px] tracking-[0.4em] uppercase rounded-xl hover:bg-neon-blue hover:text-white transition-all">
            Initiate Contact
          </button>
        </div>
      </div>
