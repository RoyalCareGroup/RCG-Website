    ...
    <div className="flex flex-col bg-[#334155] overflow-x-hidden min-h-screen selection:bg-neon-blue/30 selection:text-white px-6 sm:px-16 lg:px-24 xl:px-32 font-sans font-bold relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10 pt-48 pb-32 w-full">
        <div className="mb-24 animate-hero-reveal">
          <div className="circuit-capsule mb-10 border-2 border-neon-purple text-neon-purple bg-black px-10 py-4 flex items-center gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-16">
          <div className="lg:col-span-8 orbital-tile p-10 lg:p-16 bg-black border-2 border-white/10 relative">
             <div className="flex items-center justify-between mb-12">
                ...
                <button onClick={verifyPipeline} disabled={verifying} className="p-4 bg-white/5 border border-white/10 rounded-xl text-slate-400"><RefreshCcw size={20} className={verifying ? 'animate-spin' : ''} /></button>
             </div>
        ...
        <div className="orbital-tile p-12 bg-black border-2 border-neon-purple shadow-[0_0_50px_rgba(217,70,239,0.2)] mb-16 relative">
           ...
           <div className="space-y-4">
              {[
                ...
                { cmd: `git commit -m "fix: silent_unlock_audio_protocol // v${COMPANY_DETAILS.appVersion}"`, desc: 'Audit log creation' },
                ...
                <div key={i} className="flex flex-col md:flex-row items-center gap-4 group">
                   <div className="flex-1 bg-royal-950 p-6 rounded-xl border border-white/10 font-mono text-neon-blue text-sm flex items-center justify-between group-hover:border-neon-blue transition-all">
                      <span>{item.cmd}</span>
                      <button onClick={() => copyCommand(item.cmd)} className="p-3 bg-black hover:bg-neon-purple rounded-lg text-slate-400"><Copy size={14} /></button>
                   </div>
